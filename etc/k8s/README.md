...
Necessary helm charts are created under `etc/k8s/exchange` folder. Based on your back-office application UI, remove the other UI charts. Ex, if you are using **angular** UI, remove **web**, **blazor** and **blazor-server** charts.
...
````powershell
127.0.0.1 web.exchange.dev
127.0.0.1 exchange.dev
127.0.0.1 authserver.exchange.dev
127.0.0.1 identity.exchange.dev
127.0.0.1 administration.exchange.dev
127.0.0.1 product.exchange.dev
127.0.0.1 saas.exchange.dev
127.0.0.1 gateway-web.exchange.dev
127.0.0.1 gateway-public.exchange.dev
````
...
* Run `deploy-staging.ps1` in the `helm-chart` directory. It is deployed with the `exchange` namespace.

* *You may wait ~30 seconds on first run for preparing the database*.

* Browse https://exchange-st-public-web for public and
   https://exchange-st-web for the back-office application
