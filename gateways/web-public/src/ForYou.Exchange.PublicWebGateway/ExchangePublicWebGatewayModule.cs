...
using ForYou.Exchange.Shared.Hosting.Gateways;
using Swashbuckle.AspNetCore.SwaggerUI;
using Volo.Abp;
using Volo.Abp.Modularity;
using Yarp.ReverseProxy.Configuration;

namespace ForYou.Exchange.PublicWebGateway;

[DependsOn(
    typeof(ExchangeSharedHostingGatewaysModule)
)]
public class ExchangePublicWebGatewayModule : AbpModule
{
