...
namespace ForYou.Exchange.PublicWeb.Menus;

public class ExchangePublicWebMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public ExchangePublicWebMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                ExchangePublicWebMenus.HomePage,
                l["Menu:Home"],
                "~/",
                icon: "fa fa-home",
                order: 0
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                ExchangePublicWebMenus.ProductPage,
                "Products",
                "/Products",
