...
using ForYou.Exchange.AdministrationService.Permissions;
using ForYou.Exchange.Localization;
using ForYou.Exchange.ProductService.Web.Menus;
...
public class ExchangeMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public ExchangeMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<ExchangeResource>();
